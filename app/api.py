...
@router.get("/organizations/by-building/{building_id}")
...
@router.get("/organizations/by-activity/{activity_id}")
...
@router.get("/organizations/by-activity-type/{activity_id}")
...
@router.get("/organizations/by-name/{name}")
...
@router.get("/organizations/in-area")
